...
namespace C2InfoSys.Schedule
{
	...
	public class ScheduledTime : IScheduledItem
	{
        ...
        public ScheduledTime(EventTimeBase Base, string StrOffset) {            
            _Base = Base;
            Init(StrOffset);
        }
        ...
        /// <summary>
        /// So this gets the next run time, needs to be adjusted for a business calendar implementation
        /// </summary>
        /// <param name="time"></param>
        /// <param name="AllowExact"></param>
        /// <returns></returns>
		public virtual DateTime NextRunTime(DateTime time, bool AllowExact)
		{
		...
		protected DateTime LastSyncForTime(DateTime time)
		{
			switch (_Base)
			{
        ...
        protected DateTime IncInterval(DateTime Last)
		{
			switch (_Base)
			{
				case EventTimeBase.BySecond:
